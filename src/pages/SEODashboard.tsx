      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <Card className="mb-8 bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
          <CardHeader>
            ...
            <CardDescription>Your site's search optimization rating</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-muted-foreground">Optimized Images</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle>SEO Checkpoints</CardTitle>
                <CardDescription>Implementation status of key SEO elements</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Search engine optimization scores</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
          ...
          <TabsContent value="content" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Analysis of your site's content</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Image SEO implementation status</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="technical" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>XML sitemap configuration and status</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Technical Optimizations</CardTitle>
                <CardDescription>Infrastructure and performance enhancements</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
          ...
          <TabsContent value="schema" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Schema.org markup types in use</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Rich Snippet Eligibility</CardTitle>
                <CardDescription>Types of rich results your site qualifies for</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
