    ...
    <AppLayout>
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Total Loss from Errors</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Most Costly Mistake</CardTitle>
        ...
        {chartData.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle>Most Costly Mistakes</CardTitle>
              <CardDescription>Top 8 mistakes by total loss impact</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        {trackedErrors && trackedErrors.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle>Currently Tracked Errors</CardTitle>
              <CardDescription>
