...
export const DEFAULT_DASHBOARD_LAYOUT = [
  ...
  { i: 'totalBalance', x: 0, y: 0, w: 3, h: 2 },
  { i: 'spotWallet', x: 3, y: 0, w: 3, h: 2 },
  { i: 'winRate', x: 6, y: 0, w: 3, h: 2 },
  { i: 'totalTrades', x: 9, y: 0, w: 3, h: 2 },
  
  // Row 2: Portfolio Overview (6) + Top Movers (3) + Quick Actions (3)
  { i: 'portfolioOverview', x: 0, y: 2, w: 6, h: 3 },
  { i: 'topMovers', x: 6, y: 2, w: 3, h: 3 },
  { i: 'quickActions', x: 9, y: 2, w: 3, h: 3 },
  
  // Row 3: Recent Transactions (6) + AI Insights (3)
  { i: 'recentTransactions', x: 0, y: 5, w: 6, h: 3 },
  { i: 'aiInsights', x: 6, y: 5, w: 6, h: 3 },
];
